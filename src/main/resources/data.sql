...
VALUES ('User 1', 'user1@example.com'),
       ...
       ('User 48', 'user48@example.com'),
       ('User 49', 'user49@example.com'),
       ('User 50', 'user50@example.com'),
       ('User 51', 'user51@example.com'),
       ('User 52', 'user52@example.com'),
       ('User 53', 'user53@example.com'),
       ('User 54', 'user54@example.com'),
       ('User 55', 'user55@example.com'),
       ('User 56', 'user56@example.com'),
       ('User 57', 'user57@example.com'),
       ...
       ('User 65', 'user65@example.com'),
       ('User 66', 'user66@example.com'),
       ('User 67', 'user67@example.com'),
       ('User 68', 'user68@example.com'),
       ('User 69', 'user69@example.com'),
       ('User 70', 'user70@example.com'),
       ('User 71', 'user71@example.com'),
       ('User 72', 'user72@example.com'),
       ('User 73', 'user73@example.com'),
       ('User 74', 'user74@example.com'),
       ('User 75', 'user75@example.com'),
       ('User 76', 'user76@example.com'),
       ('User 77', 'user77@example.com'),
       ('User 78', 'user78@example.com'),
       ('User 79', 'user79@example.com'),
       ('User 80', 'user80@example.com'),
       ('User 81', 'user81@example.com'),
       ('User 82', 'user82@example.com'),
       ('User 83', 'user83@example.com'),
       ('User 84', 'user84@example.com'),
       ('User 85', 'user85@example.com'),
       ('User 86', 'user86@example.com'),
       ('User 87', 'user87@example.com'),
       ('User 88', 'user88@example.com'),
       ('User 89', 'user89@example.com'),
       ('User 90', 'user90@example.com'),
       ('User 91', 'user91@example.com'),
       ('User 92', 'user92@example.com'),
       ('User 93', 'user93@example.com'),
       ('User 94', 'user94@example.com'),
       ('User 95', 'user95@example.com'),
       ('User 96', 'user96@example.com'),
       ('User 97', 'user97@example.com'),
